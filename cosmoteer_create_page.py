...
PART_DATA = {
    ...
    "cosmoteer.thruster_small_3way": {"command": -3, "cost": 1500, "mass": 1.91, },
    "cosmoteer.thruster_med": {"command": -2, "cost": 1500, "mass": 2.45, },
    "cosmoteer.thruster_large": {"command": -4, "cost": 4000, "mass": 4.99, },
    "cosmoteer.thruster_huge": {"command": -8, "cost": 10000, "mass": 11.0, },
    "cosmoteer.thruster_boost": {"command": -6, "cost": 6000, "mass": 8.88, },
    ...
    "cosmoteer.resonance_beam_turret": {"command": -8, "cost": 16000, "mass": 21.54, },
    ...
    "cosmoteer.laser_blaster_large": {"command": -4, "cost": 5000, "mass": 7.68, },
    "cosmoteer.disruptor": {"command": -2, "cost": 3000, "mass": 3.48, },
    ...
    "cosmoteer.shield_gen_large": {"command": -6, "cost": 20000, "mass": 12.65, },
    "cosmoteer.fire_extinguisher": {"command": 0, "cost": 300, "mass": 1.0, },
    "cosmoteer.point_defense": {"command": -1, "cost": 1000, "mass": 1.2, },

    "cosmoteer.structure": {"command": 0, "cost": 50, "mass": 0.33, },
    "cosmoteer.structure_wedge": {"command": 0, "cost": 25, "mass": 0.17, },
    ...
    "cosmoteer.armor_structure_hybrid_tri": {"command": 0, "cost": 75, "mass": 0.75, },
    ...
    "cosmoteer.hyperdrive_beacon": {"command": -12, "cost": 40000, "mass": 17.13, },
    "cosmoteer.sensor_array": {"command": -8, "cost": 20000, "mass": 11.54, },
    "cosmoteer.manipulator_beam_emitter": {"command": -4, "cost": 3000, "mass": 4.0, },
    "cosmoteer.tractor_beam_emitter": {"command": -8, "cost": 40000, "mass": 32.07, },
